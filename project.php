...
<marquee style="font margin-top:20px;margin-right:0px;font-size:40px;">WELCOME TO DATE SKATERS
</marquee></a>
...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small">Select the perfect partner</span><br>
    ...
    <p><a href="#profiles" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Search here</a></p>
  </div> 
...
<div class="w3-container" style="padding:128px 16px" id="about">
  <h3 class="w3-center">ABOUT THE DATE SKATERS</h3>
...
<div class="w3-container" style="padding:128px 16px" id="team">
  ...
  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/admin1.jpg" alt="admin1" style="width:100%;height:250px;">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/admin2.jpg" alt="admin2" style="width:100%;height:250px;">
        <div class="w3-container">
          <h3>Loura Salet</h3>
          <p class="w3-opacity">Web Designer</p>
          <!-- <p></p> -->
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/admin3.jpg" alt="admin3" style="width:100%;height:250px;">
        <div class="w3-container">
          <h3>David Claud</h3>
          <p class="w3-opacity">Web Designer</p>
          <!-- <p></p> -->
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="images/admin4.jpg" alt="admin4" style="width:100%;height:250px;">
        <div class="w3-container">
          <h3>Noura Claud</h3>
          <p class="w3-opacity">Web Designer</p>
          <!-- <p></p> -->
...
<footer class="w3-center w3-black w3-padding-64">
  ...
  <p>Powered by <a href="#" title="W3.CSS" target="_blank" class="w3-hover-text-green">dreamskaters</a></p>
</footer>
